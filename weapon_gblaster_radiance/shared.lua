...
SWEP.PrintName            = "Brilliant Radiance"
SWEP.Slot            = 3
SWEP.SlotPos            = 4
SWEP.DrawAmmo            = true
...
SWEP.VElements = {
	...
	["Console"] = { type = "Model", model = "models/props_lab/console02c.mdl", bone = "Base", rel = "", pos = Vector(0.745, 1.712, -17.49), angle = Angle(0, 0, -90), size = Vector(0.18, 0.18, 0.18), color = Color(255, 154, 0, 255), surpresslightning = false, material = "matrix5", skin = 0, bodygroup = {} },
	["Gaster"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "Base", rel = "", pos = Vector(0, -3.412, 8.432), angle = Angle(90, 0, -90), size = Vector(0.495, 0.495, 0.495), color = Color(255, 154, 0, 255), surpresslightning = false, material = "matrix5", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["Gaster"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(24.965, -5.685, -9.4), angle = Angle(-30, 21.666, -157.198), size = Vector(0.384, 0.384, 0.384), color = Color(255, 101, 0, 255), surpresslightning = false, material = "matrix5", skin = 0, bodygroup = {} },
	...
	["Console"] = { type = "Model", model = "models/props_lab/console02c.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.872, -0.667, -7.35), angle = Angle(-161.691, 98.208, -4.665), size = Vector(0.123, 0.123, 0.123), color = Color(255, 101, 0, 255), surpresslightning = false, material = "matrix5", skin = 0, bodygroup = {} }
}
...
function SWEP:Deploy()
	...
	self.BeatSound = CreateSound( self.Owner, Sound( "weapons/gblaster/radiance_holding.mp3" ) )
...
function SWEP:PrimaryAttack()
	...
	if ( self.Owner:IsNPC() ) then
		...
		if ( self.LoopSound ) then
			...
			self.LoopSound = CreateSound( self.Owner, Sound("weapons/gblaster/radiance_firing.mp3") )
	...
	local bullet = {} 
		...
		bullet.TracerName = "radiance_ray"
...
function SWEP:DrawHUD()
    ...
    surface.SetDrawColor(Color(255,131,0))
    ...
    surface.SetDrawColor(255,131,0,255)
