...
SWEP.VElements = {
	["Console+"] = { type = "Model", model = "models/props_trainstation/trainstation_clock001.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "", pos = Vector(27.43, -80, -1.275), angle = Angle(-180, 79.918, 61.064), size = Vector(0.202, 0.202, 0.202), color = Color(255, 255, 255, 51), surpresslightning = true, material = "", skin = 0, bodygroup = {} },
	["Laser"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "Base", rel = "", pos = Vector(-0.917, 18.593, 0.615), angle = Angle(-90, 90, 0), size = Vector(0.2, 0.2, 0.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "effects/jazz_void_refract", skin = 0, bodygroup = {} },
	["Gaster"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "Base", rel = "", pos = Vector(0, -2.991, 10.357), angle = Angle(90, 0, -90), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "effects/jazz_void_refract", skin = 0, bodygroup = {} },
	["Console"] = { type = "Model", model = "models/props_lab/console02c.mdl", bone = "Base", rel = "", pos = Vector(-2.922, 1.46, -17.49), angle = Angle(0, 0, -90), size = Vector(0.18, 0.18, 0.18), color = Color(255, 255, 255, 255), surpresslightning = false, material = "effects/jazz_void_refract", skin = 0, bodygroup = {} },
	["Console++"] = { type = "Model", model = "models/sprops/misc/alphanum/alphanum_star_3.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "", pos = Vector(27.43, -80, -1.275), angle = Angle(-90.125, 79.918, 61.064), size = Vector(0.224, 0.224, 0.224), color = Color(0, 0, 0, 255), surpresslightning = false, material = "effects/jazz_void_refract", skin = 0, bodygroup = {} }
}
...
function SWEP:Deploy()
	...
	self.BeatSound = CreateSound( self.Owner, Sound( "weapons/gblaster/thechariot_ambience.mp3" ) )
	...
	if self.Owner:KeyDown(IN_ATTACK) and self.CandoSpecial == true then
		...
		if self.Owner:IsPlayer() then
			if ( self.LoopSound ) then
				...
				self.LoopSound = CreateSound( self.Owner, Sound( "weapons/gblaster/thechariot_ambience.mp3" ) )
