...
SWEP.PrintName			= "Contained Corruption"
SWEP.Slot			= 3
SWEP.SlotPos			= 4
SWEP.DrawAmmo			= true
...
SWEP.VElements = {
	["element_name2+++"] = { type = "Model", model = "models/props_lab/console02c.mdl", bone = "Base", rel = "", pos = Vector(-2.921, 1.46, -16.449), angle = Angle(0, 0, -90), size = Vector(0.18, 0.18, 0.18), color = Color(255, 255, 255, 255), surpresslightning = true, material = "/z_easyskins/camo/corruptedspy_body_uber", skin = 0, bodygroup = {} },
	["element_name3+++"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "Base", rel = "", pos = Vector(0, -2.991, 10.357), angle = Angle(90, 0, -90), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = true, material = "/z_easyskins/camo/corruptedspy_body_uber", skin = 0, bodygroup = {} },
	["element_name+++"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "Base", rel = "", pos = Vector(-0.917, 18.593, 0.616), angle = Angle(-90, 90, 0), size = Vector(0.2, 0.2, 0.2), color = Color(255, 255, 255, 255), surpresslightning = true, material = "/z_easyskins/camo/corruptedspy_body_uber", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["element_name++++"] = { type = "Model", model = "models/props_lab/console02c.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.872, -0.667, -7.375), angle = Angle(-161.691, 98.208, -4.664), size = Vector(0.123, 0.123, 0.123), color = Color(255, 255, 255, 255), surpresslightning = true, material = "/z_easyskins/camo/corruptedspy_body_uber", skin = 0, bodygroup = {} },
	["element_name++++++"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(16.913, -0.159, 1.699), angle = Angle(175.675, 11.01, -21.651), size = Vector(0.112, 0.112, 0.112), color = Color(255, 255, 255, 255), surpresslightning = true, material = "/z_easyskins/camo/corruptedspy_body_uber", skin = 0, bodygroup = {} },
	["element_name+++++"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(24.966, -5.684, -9.4), angle = Angle(-30, 21.666, -157.198), size = Vector(0.384, 0.384, 0.384), color = Color(255, 255, 255, 255), surpresslightning = true, material = "/z_easyskins/camo/corruptedspy_body_uber", skin = 0, bodygroup = {} }
}
...
function SWEP:Deploy()
	...
	self.BeatSound = CreateSound( self.Owner, Sound( "weapons/gblaster/contained_holding.mp3" ) )
	...
	if self.Owner:KeyDown(IN_ATTACK) and self.CandoSpecial == true then
		...
		if self.Owner:IsPlayer() then
			if ( self.LoopSound ) then
				...
				self.LoopSound = CreateSound( self.Owner, Sound( "weapons/gblaster/contained_firing.mp3" ) )
