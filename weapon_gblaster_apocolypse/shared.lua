...
SWEP.WElements = {
	["gaster"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(26.493, -4.676, -8.832), angle = Angle(-153.118, -162.469, 17.531), size = Vector(0.49, 0.49, 0.49), color = Color(65, 0, 0, 255), surpresslightning = false, material = "models/props_lab/cornerunit_cloud", skin = 0, bodygroup = {} },
	["cube+"] = { type = "Model", model = "models/props_questionableethics/qe_primarylaser.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(15.817, -0.159, 1.557), angle = Angle(175.675, 11.01, -12.858), size = Vector(0.109, 0.109, 0.109), color = Color(255, 0, 255, 35), surpresslightning = false, material = "models/props_combine/stasisfield_beam", skin = 0, bodygroup = {} },
	["clock"] = { type = "Model", model = "models/props_c17/clock01.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(6.752, -4.676, -6.753), angle = Angle(90, 8.182, -85.325), size = Vector(0.367, 0.367, 0.367), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["cube"] = { type = "Model", model = "models/props_questionableethics/qe_primarylaser.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(15.817, -0.159, 1.557), angle = Angle(175.675, 11.01, -12.858), size = Vector(0.108, 0.108, 0.108), color = Color(65, 0, 0, 255), surpresslightning = false, material = "models/props_lab/cornerunit_cloud", skin = 0, bodygroup = {} },
	["gaster+"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(26.493, -4.676, -8.832), angle = Angle(-153.118, -162.469, 17.531), size = Vector(0.55, 0.55, 0.55), color = Color(255, 0, 255, 255), surpresslightning = false, material = "models/props_combine/stasisfield_beam", skin = 0, bodygroup = {} },
	["pentagram+"] = { type = "Model", model = "models/pentagram/pentagram_medium.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(33.765, -6.753, -11.948), angle = Angle(36.234, 43.247, -8.183), size = Vector(0.367, 0.367, 0.367), color = Color(255, 0, 0, 255), surpresslightning = false, material = "matrix5", skin = 0, bodygroup = {} }
}

SWEP.VElements = {
	["gaster"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "Base", rel = "", pos = Vector(-2.597, -1.558, 37.922), angle = Angle(92.337, -90, 0), size = Vector(0.99, 0.99, 0.99), color = Color(255, 0, 255, 255), surpresslightning = false, material = "models/props_combine/portalball001_sheet", skin = 0, bodygroup = {} },
	["cube+"] = { type = "Model", model = "models/props_questionableethics/qe_primarylaser.mdl", bone = "Base", rel = "", pos = Vector(0, 18.181, 2.596), angle = Angle(-90, 90, 0), size = Vector(0.2, 0.2, 0.2), color = Color(150, 0, 120, 255), surpresslightning = false, material = "models/props_combine/portalball001_sheet", skin = 0, bodygroup = {} },
	["gaster++"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "Base", rel = "", pos = Vector(-2.597, -1.558, 37.922), angle = Angle(92.337, -90, 0), size = Vector(0.958, 0.958, 0.958), color = Color(65, 0, 0, 255), surpresslightning = false, material = "matrix5", skin = 9, bodygroup = {} },
	["skull 3"] = { type = "Model", model = "models/Gibs/HGIBS.mdl", bone = "Base", rel = "", pos = Vector(-6.753, -5.715, -14.027), angle = Angle(-73.637, 8.182, -108.701), size = Vector(0.625, 0.625, 0.625), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["skull"] = { type = "Model", model = "models/Gibs/HGIBS.mdl", bone = "Base", rel = "", pos = Vector(7.791, -5.715, -15.065), angle = Angle(-97.014, 3.506, -66.624), size = Vector(0.625, 0.625, 0.625), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["cube"] = { type = "Model", model = "models/props_questionableethics/qe_primarylaser.mdl", bone = "Base", rel = "", pos = Vector(0, 18.181, 2.596), angle = Angle(-90, 90, 0), size = Vector(0.2, 0.2, 0.2), color = Color(85, 0, 0, 255), surpresslightning = false, material = "matrix5", skin = 0, bodygroup = {} },
	["pentagram"] = { type = "Model", model = "models/pentagram/pentagram_small.mdl", bone = "Base", rel = "", pos = Vector(-0.519, -7.792, 22.337), angle = Angle(10.519, 15.194, 24.545), size = Vector(1.924, 1.924, 1.924), color = Color(255, 0, 0, 255), surpresslightning = false, material = "matrix5", skin = 0, bodygroup = {} },
	["clock"] = { type = "Model", model = "models/props_c17/clock01.mdl", bone = "Base", rel = "", pos = Vector(0.518, -2.597, -21.299), angle = Angle(-40.91, -90, 180), size = Vector(0.56, 0.56, 0.56), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["skull 2"] = { type = "Model", model = "models/Gibs/HGIBS.mdl", bone = "Base", rel = "", pos = Vector(0.518, -6.753, -17.143), angle = Angle(-78.312, 82.986, -5.844), size = Vector(0.625, 0.625, 0.625), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
function SWEP:Deploy()
	...
	self.BeatSound = CreateSound( self.Owner, Sound( "weapons/gblaster/apocolypse_holding.mp3" ) )
	...
	if self.Owner:KeyDown(IN_ATTACK) and self.CandoSpecial == true then
		...
		if self.Owner:IsPlayer() then
			if ( self.LoopSound ) then
				...
				self.LoopSound = CreateSound( self.Owner, Sound( "weapons/gblaster/apocolypse_firing.mp3" ) )
