...
SWEP.WorldModel = "models/player/heavyt/heavyt.mdl"
SWEP.ShowViewModel = true
SWEP.ShowWorldModel = true

SWEP.Purpose			= "C U M"
SWEP.Instructions		= "CUM WE FUCK LIKE DIS HOOOOHAAAAHAHAHAHAHAHAHAHAHA"
...
SWEP.VElements = {
	...
	["Console+"] = { type = "Model", model = "models/props_lab/console02c.mdl", bone = "Base", rel = "", pos = Vector(-2.921, 1.46, -16.449), angle = Angle(0, 0, -90), size = Vector(0.18, 0.18, 0.18), color = Color(0, 0, 0, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "models/ultrakill/vfx/bonusp_1", skin = 0, bodygroup = {} },
	["Gaster"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "Base", rel = "", pos = Vector(0, -2.991, 10.357), angle = Angle(90, 0, -90), size = Vector(0.536, 0.536, 0.536), color = Color(255, 0, 0, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "models/debug/debugwhite", skin = 0, bodygroup = {} },
	["Gaster+++++++++++"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "Base", rel = "", pos = Vector(0, -2.991, 10.357), angle = Angle(90, 0, -90), size = Vector(0.536, 0.536, 0.536), color = Color(0, 0, 0, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "models/ultrakill/vfx/bonusp_1", skin = 0, bodygroup = {} },
	["H I M"] = { type = "Model", model = "models/player/heavyt/heavyt.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "", pos = Vector(8.586, -37.876, 47.973), angle = Angle(-128.276, 76.469, 85.65), size = Vector(0.34, 0.34, 0.34), color = Color(255, 255, 255, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "", skin = 0, bodygroup = {} },
	["H I M+"] = { type = "Model", model = "models/weapons/w_models/w_grenadelauncher.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "", pos = Vector(18.312, -44.036, 45.658), angle = Angle(-134.60201, 81.772, 88.042), size = Vector(0.468, 0.468, 0.468), color = Color(255, 255, 255, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "", skin = 0, bodygroup = {} },
	["H I M++"] = { type = "Model", model = "models/weapons/w_models/w_grenade_grenadelauncher.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "", pos = Vector(17.501, -30.747, 32.366), angle = Angle(-134.60201, 81.772, 88.042), size = Vector(0.237, 0.237, 0.237), color = Color(255, 255, 255, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "", skin = 0, bodygroup = {} },
	["Laser"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "Base", rel = "", pos = Vector(-0.917, 18.593, 0.616), angle = Angle(-90, 90, 0), size = Vector(0.2, 0.2, 0.2), color = Color(255, 255, 255, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "models/debug/debugwhite", skin = 0, bodygroup = {} },
	["Laser+"] = { type = "Model", model = "models/items/plate.mdl", bone = "Base", rel = "", pos = Vector(4.299, -4.321, -16.063), angle = Angle(-90, 90, 0), size = Vector(0.2, 0.2, 0.2), color = Color(255, 255, 255, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "", skin = 0, bodygroup = {} },
	["Laser++++++"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "Base", rel = "", pos = Vector(-0.917, 18.593, 0.616), angle = Angle(-90, 90, 0), size = Vector(0.2, 0.2, 0.2), color = Color(0, 0, 0, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "models/ultrakill/vfx/bonusp_1", skin = 0, bodygroup = {} }
	}
--SWEP.WElements = {
--}
...
--	self.Owner:EmitSound(Sound("weapons/gblaster/CentaurSpotted.mp3"))
	...
	self.BeatSound = CreateSound( self.Owner, Sound( "weapons/gblaster/assgrabber_holding.mp3" ) )
...
function SWEP:PrimaryAttack()
	...
	if self.Owner:KeyDown(IN_ATTACK) and self.CandoSpecial == true then
		...
		if self.Owner:IsPlayer() then
			if ( self.LoopSound ) then
				...
				self.LoopSound = CreateSound( self.Owner, Sound( "weapons/gblaster/assgrabber_firing.mp3" ) )
	...
	local bullet = {} 
		...
		bullet.TracerName = "asseater_ray"
