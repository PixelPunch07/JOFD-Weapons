...
SWEP.PrintName            = "Fraudulence - Profaned Community"
SWEP.Slot            = 3
SWEP.SlotPos            = 4
SWEP.DrawAmmo            = true
...
function SWEP:Deploy()
	...
	self.BeatSound = CreateSound( self.Owner, Sound( "weapons/gblaster/fraud2_holding.mp3" ) )
...
function SWEP:PrimaryAttack()
	...
	if ( self.Owner:IsNPC() ) then
		...
		if ( self.LoopSound ) then
			...
			self.LoopSound = CreateSound( self.Owner, Sound("weapons/gblaster/fraud2_firing.mp3") )
