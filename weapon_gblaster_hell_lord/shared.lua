...
SWEP.Purpose			= "you ruled a perfect realm but now look at you"
SWEP.Instructions		= "reclaim what was yours."
...
SWEP.VElements = {
	["core+"] = { type = "Model", model = "models/props_lab/labpar5.mdl", bone = "Base", rel = "", pos = Vector(0.518, -2.597, -18.182), angle = Angle(22.208, 90, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 0, 0, 255), surpresslightning = false, material = "Models/effects/comball_sphere", skin = 0, bodygroup = {} },
	["gaster+++"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "Base", rel = "", pos = Vector(-0.519, -3.636, 21.298), angle = Angle(99.35, -80.65, -8.183), size = Vector(0.699, 0.699, 0.699), color = Color(255, 0, 0, 180), surpresslightning = false, material = "models/debug/debugwhite", skin = 0, bodygroup = {} },
	["cube"] = { type = "Model", model = "models/props_questionableethics/qe_primarylaser.mdl", bone = "Base", rel = "", pos = Vector(0, 18.181, 2.596), angle = Angle(-90, 90, 0), size = Vector(0.2, 0.2, 0.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/player/shared/ice_player", skin = 0, bodygroup = {} },
	["core"] = { type = "Model", model = "models/props_lab/labpar5.mdl", bone = "Base", rel = "", pos = Vector(0.518, -2.597, -18.182), angle = Angle(22.208, 90, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/player/shared/ice_player", skin = 0, bodygroup = {} },
	["gaster++"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "Base", rel = "", pos = Vector(-0.519, -3.636, 21.298), angle = Angle(99.35, -80.65, -8.183), size = Vector(0.649, 0.649, 0.649), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/player/shared/ice_player", skin = 0, bodygroup = {} },
	["console"] = { type = "Model", model = "models/props_lab/console02c.mdl", bone = "Base", rel = "", pos = Vector(-2.597, 1.557, -7.792), angle = Angle(0, 0, -92.338), size = Vector(0.189, 0.189, 0.189), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/player/shared/ice_player", skin = 0, bodygroup = {} },
	["crown"] = { type = "Model", model = "models/Mechanics/gears2/vert_12t1.mdl", bone = "Base", rel = "", pos = Vector(-0.519, -16.105, 23.377), angle = Angle(0, 0, -92.338), size = Vector(0.649, 0.649, 0.649), color = Color(255, 0, 0, 255), surpresslightning = false, material = "models/wireframe", skin = 0, bodygroup = {} },
	["console+"] = { type = "Model", model = "models/props_lab/console02c.mdl", bone = "Base", rel = "", pos = Vector(-2.597, 1.557, -7.792), angle = Angle(0, 0, -92.338), size = Vector(0.2, 0.2, 0.2), color = Color(255, 0, 0, 255), surpresslightning = false, material = "Models/effects/comball_sphere", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["gaster"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(25.454, -5.715, -10.91), angle = Angle(-155.456, -160.131, 22.201), size = Vector(0.449, 0.449, 0.449), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/player/shared/ice_player", skin = 0, bodygroup = {} },
	["cube"] = { type = "Model", model = "models/props_questionableethics/qe_primarylaser.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(15.817, 0.518, 0.344), angle = Angle(175.675, 11.01, -21.651), size = Vector(0.108, 0.108, 0.108), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/player/shared/ice_player", skin = 0, bodygroup = {} },
	["crown"] = { type = "Model", model = "models/Mechanics/gears2/vert_18t1.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(25.454, -7.792, -16.105), angle = Angle(-6.875, 1.652, -160.508), size = Vector(0.4, 0.4, 0.4), color = Color(255, 0, 0, 255), surpresslightning = false, material = "models/wireframe", skin = 0, bodygroup = {} },
	["gaster+"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(25.454, -5.715, -10.91), angle = Angle(-155.456, -160.131, 22.201), size = Vector(0.56, 0.56, 0.56), color = Color(255, 0, 0, 254), surpresslightning = false, material = "models/player/shared/ice_player", skin = 0, bodygroup = {} },
	["cube+"] = { type = "Model", model = "models/props_questionableethics/qe_primarylaser.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(15.817, 0.518, 0.344), angle = Angle(175.675, 11.01, -21.651), size = Vector(0.112, 0.112, 0.112), color = Color(255, 0, 0, 254), surpresslightning = false, material = "models/player/shared/ice_player", skin = 0, bodygroup = {} },
	["eye"] = { type = "Model", model = "models/hunter/misc/sphere2x2.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(34.396, -4.349, -10.926), angle = Angle(0, 0, 0), size = Vector(0.029, 0.029, 0.029), color = Color(255, 0, 0, 255), surpresslightning = false, material = "models/player/shared/ice_player", skin = 0, bodygroup = {} }
}
...
function SWEP:Deploy()
	...
	self.BeatSound = CreateSound( self.Owner, Sound( "weapons/gblaster/helllord_holding.mp3" ) )
	...
	if self.Owner:KeyDown(IN_ATTACK) and self.CandoSpecial == true then
		...
		if self.Owner:IsPlayer() then
			if ( self.LoopSound ) then
				...
				self.LoopSound = CreateSound( self.Owner, Sound( "weapons/gblaster/helllord_firing.mp3" ) )
