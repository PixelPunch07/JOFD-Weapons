...
SWEP.PrintName			= "Enigmatic Insanity"
SWEP.Slot			= 3
SWEP.SlotPos			= 4
SWEP.DrawAmmo			= true
...
SWEP.VElements = {
	["Console"] = { type = "Model", model = "models/props_lab/console02c.mdl", bone = "Base", rel = "", pos = Vector(-2.921, 1.46, -16.449), angle = Angle(0, 0, -90), size = Vector(0.18, 0.18, 0.18), color = Color(127, 63, 63, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "models/player/shared/ice_player", skin = 0, bodygroup = {} },
	["Console+"] = { type = "Model", model = "models/props_lab/console02c.mdl", bone = "Base", rel = "", pos = Vector(-2.921, 1.46, -16.449), angle = Angle(0, 0, -90), size = Vector(0.18, 0.18, 0.18), color = Color(127, 63, 63, 153), surpresslightning = false, bonemerge = false, highrender = false, material = "matrix5", skin = 0, bodygroup = {} },
	["Gaster"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "Base", rel = "", pos = Vector(0, -2.991, 10.357), angle = Angle(90, 0, -90), size = Vector(0.536, 0.536, 0.536), color = Color(127, 63, 63, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "models/player/shared/ice_player", skin = 0, bodygroup = {} },
	["Gaster+++++++++++"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "Base", rel = "", pos = Vector(0, -2.991, 10.357), angle = Angle(90, 0, -90), size = Vector(0.536, 0.536, 0.536), color = Color(127, 63, 63, 153), surpresslightning = false, bonemerge = false, highrender = false, material = "matrix5", skin = 0, bodygroup = {} },
	["Laser"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "Base", rel = "", pos = Vector(-0.917, 18.593, 0.616), angle = Angle(-90, 90, 0), size = Vector(0.2, 0.2, 0.2), color = Color(127, 63, 63, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "models/player/shared/ice_player", skin = 0, bodygroup = {} },
	["Laser++++"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "Base", rel = "", pos = Vector(-0.917, 18.593, 0.616), angle = Angle(-90, 90, 0), size = Vector(0.2, 0.2, 0.2), color = Color(127, 63, 63, 153), surpresslightning = false, bonemerge = false, highrender = false, material = "matrix5", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["console"] = { type = "Model", model = "models/props_lab/console02c.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.872, -0.667, -7.375), angle = Angle(-158.491, 98.208, -4.664), size = Vector(0.123, 0.123, 0.123), color = Color(127, 63, 63, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "models/player/shared/ice_player", skin = 0, bodygroup = {} },
	["console+"] = { type = "Model", model = "models/props_lab/console02c.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.872, -0.667, -7.375), angle = Angle(-158.491, 98.208, -4.664), size = Vector(0.123, 0.123, 0.123), color = Color(127, 63, 63, 153), surpresslightning = false, bonemerge = false, highrender = false, material = "matrix5", skin = 0, bodygroup = {} },
	["gaster"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(26.541, -5.684, -9.4), angle = Angle(-30, 21.666, -157.198), size = Vector(0.5, 0.5, 0.5), color = Color(127, 63, 63, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "models/player/shared/ice_player", skin = 0, bodygroup = {} },
	["gaster++++++++++++++"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(26.541, -5.684, -9.4), angle = Angle(-30, 21.666, -157.198), size = Vector(0.5, 0.5, 0.5), color = Color(125, 64, 64, 153), surpresslightning = false, bonemerge = false, highrender = false, material = "matrix5", skin = 0, bodygroup = {} },
	["laser"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(16.913, -0.159, 1.699), angle = Angle(175.675, 11.01, -21.651), size = Vector(0.116, 0.116, 0.116), color = Color(127, 63, 63, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "models/player/shared/ice_player", skin = 0, bodygroup = {} },
	["laser+++"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(16.913, -0.159, 1.699), angle = Angle(175.675, 11.01, -21.651), size = Vector(0.116, 0.116, 0.116), color = Color(127, 63, 63, 153), surpresslightning = false, bonemerge = false, highrender = false, material = "matrix5", skin = 0, bodygroup = {} }
}
...
function SWEP:Deploy()
	...
	self.BeatSound = CreateSound( self.Owner, Sound( "weapons/gblaster2/enigmatic_holding.mp3" ) )
...
function SWEP:PrimaryAttack()
	...
	if self.Owner:KeyDown(IN_ATTACK) and self.CandoSpecial == true then
		...
		if self.Owner:IsPlayer() then
			if ( self.LoopSound ) then
				...
				self.LoopSound = CreateSound( self.Owner, Sound( "weapons/gblaster2/enigmatic_holding.mp3" ) )
	...
	if self.Owner:IsNPC() then
		...
		if ( self.LoopSound ) then
			...
			self.LoopSound = CreateSound( self.Owner, Sound( "weapons/gblaster2/enigmatic_firing.mp3" ) )
			if ( self.LoopSound ) then self.LoopSound:Play() end
		end
		if ( self.BeatSound ) then self.BeatSound:ChangeVolume( 0, 0.1 ) end
	end
	...
	local bullet = {} 
		...
		bullet.TracerName = "enigmatic_ray"
