...
SWEP.PrintName			= "Idolatrize World"
SWEP.Slot			= 3
SWEP.SlotPos			= 4
SWEP.DrawAmmo			= true
...
SWEP.Purpose			= "IDOLATRIZE THE WORLD!"
SWEP.Instructions		= "I entrust the world to an idol like you."
...
SWEP.VElements = {
	["Laser++++"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "Base", rel = "", pos = Vector(-0.917, 18.593, 0.615), angle = Angle(-90, 90, 0), size = Vector(0.2, 0.2, 0.2), color = Color(255, 255, 0, 255), surpresslightning = false, material = "Models/effects/comball_tape", skin = 0, bodygroup = {} },
	["Gaster++++"] = { type = "Model", model = "models/touhou/note_1.mdl", bone = "Base", rel = "", pos = Vector(0.907, -10.013, 3.163), angle = Angle(180, 90.626, -180), size = Vector(0.075, 0.075, 0.075), color = Color(255, 255, 0, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["Laser+++"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "Base", rel = "", pos = Vector(-0.917, 18.593, 0.615), angle = Angle(-90, 90, 0), size = Vector(0.2, 0.2, 0.2), color = Color(255, 255, 0, 255), surpresslightning = false, material = "Models/effects/comball_tape", skin = 0, bodygroup = {} },
	["Laser++"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "Base", rel = "", pos = Vector(-0.917, 18.593, 0.615), angle = Angle(-90, 90, 0), size = Vector(0.2, 0.2, 0.2), color = Color(0, 255, 0, 255), surpresslightning = false, material = "models/props_combine/prtl_sky_sheet", skin = 0, bodygroup = {} },
	["Gaster+++"] = { type = "Model", model = "models/dead_ringer.mdl", bone = "Base", rel = "", pos = Vector(0.907, -9.063, 3.642), angle = Angle(180, 0, -90), size = Vector(0.5, 0.5, 0.5), color = Color(0, 255, 0, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["Gaster+"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "Base", rel = "", pos = Vector(0, -2.991, 10.357), angle = Angle(90, 0, -90), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 0, 255), surpresslightning = false, material = "Models/effects/comball_tape", skin = 0, bodygroup = {} },
	["Laser+"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "Base", rel = "", pos = Vector(-0.917, 18.593, 0.615), angle = Angle(-90, 90, 0), size = Vector(0.2, 0.2, 0.2), color = Color(255, 255, 0, 255), surpresslightning = false, material = "Models/effects/comball_tape", skin = 0, bodygroup = {} },
	["Gaster++"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "Base", rel = "", pos = Vector(0, -2.991, 10.357), angle = Angle(90, 0, -90), size = Vector(0.5, 0.5, 0.5), color = Color(0, 255, 0, 255), surpresslightning = false, material = "models/props_combine/prtl_sky_sheet", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["gaster"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(26.541, -5.684, -9.4), angle = Angle(-30, 21.666, -157.198), size = Vector(0.5, 0.5, 0.5), color = Color(33, 255, 0, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "models/props_combine/prtl_sky_sheet", skin = 0, bodygroup = {} },
	["gaster+"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(26.541, -5.684, -9.4), angle = Angle(-30, 21.666, -157.198), size = Vector(0.5, 0.5, 0.5), color = Color(33, 255, 0, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "Models/effects/comball_tape", skin = 0, bodygroup = {} },
	["laser"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(16.913, -0.159, 1.699), angle = Angle(175.675, 11.01, -21.651), size = Vector(0.116, 0.116, 0.116), color = Color(33, 255, 0, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "models/props_combine/prtl_sky_sheet", skin = 0, bodygroup = {} },
	["laser+"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(16.913, -0.159, 1.699), angle = Angle(175.675, 11.01, -21.651), size = Vector(0.116, 0.116, 0.116), color = Color(255, 255, 255, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "Models/effects/comball_tape", skin = 0, bodygroup = {} }
}
...
function SWEP:Deploy()
	...
	self.BeatSound = CreateSound( self.Owner, Sound( "weapons/gblaster2/idolatrize_holding.mp3" ) )
...
function SWEP:PrimaryAttack()
	...
	if self.Owner:KeyDown(IN_ATTACK) and self.CandoSpecial == true then
		...
		if self.Owner:IsPlayer() then
			if ( self.LoopSound ) then
				...
				self.LoopSound = CreateSound( self.Owner, Sound( "weapons/gblaster2/idolatrize_holding.mp3" ) )
	...
	if self.Owner:IsNPC() then
		...
		if ( self.LoopSound ) then
			...
			self.LoopSound = CreateSound( self.Owner, Sound( "weapons/gblaster2/idolatrize_firing.mp3" ) )
			if ( self.LoopSound ) then self.LoopSound:Play() end
		end
		if ( self.BeatSound ) then self.BeatSound:ChangeVolume( 0, 0.1 ) end
	end
