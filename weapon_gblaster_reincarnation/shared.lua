...
SWEP.VElements = {
	["element_name2+"] = { type = "Model", model = "models/props_lab/console02c.mdl", bone = "Base", rel = "", pos = Vector(-2.921, 1.46, -16.449), angle = Angle(0, 0, -90), size = Vector(0.18, 0.18, 0.18), color = Color(0, 255, 0, 255), surpresslightning = false, material = "models/props_lab/cornerunit_cloud", skin = 0, bodygroup = {} },
	["element_name2++++"] = { type = "Model", model = "models/player/gibs/pyrogib003.mdl", bone = "Base", rel = "", pos = Vector(3.703, 21.798, -31.286), angle = Angle(-125.817, -131.314, 138.585), size = Vector(0.629, 0.629, 0.629), color = Color(0, 255, 0, 255), surpresslightning = true, material = "models/props_lab/cornerunit_cloud", skin = 0, bodygroup = {} },
	["element_name2+++"] = { type = "Model", model = "models/player/gibs/pyrogib003.mdl", bone = "Base", rel = "", pos = Vector(7.993, 36.127, -15.415), angle = Angle(180, -180, 105.378), size = Vector(0.629, 0.629, 0.629), color = Color(0, 255, 0, 255), surpresslightning = true, material = "models/props_lab/cornerunit_cloud", skin = 0, bodygroup = {} },
	["element_name3+"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "Base", rel = "", pos = Vector(0, -2.991, 10.357), angle = Angle(90, 0, -90), size = Vector(0.5, 0.5, 0.5), color = Color(0, 255, 0, 255), surpresslightning = false, material = "models/props_lab/cornerunit_cloud", skin = 0, bodygroup = {} },
	["element_name+"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "Base", rel = "", pos = Vector(-0.917, 18.593, 0.616), angle = Angle(-90, 90, 0), size = Vector(0.2, 0.2, 0.2), color = Color(0, 255, 0, 255), surpresslightning = false, material = "models/props_lab/cornerunit_cloud", skin = 0, bodygroup = {} },
	["element_name2++"] = { type = "Model", model = "models/player/gibs/pyrogib003.mdl", bone = "Base", rel = "", pos = Vector(-12.537, -12.363, -10.737), angle = Angle(180, -119.663, -63.03), size = Vector(0.439, 0.439, 0.439), color = Color(0, 255, 0, 255), surpresslightning = true, material = "models/props_lab/cornerunit_cloud", skin = 0, bodygroup = {} }
}
...
function SWEP:Deploy()
	...
	self.BeatSound = CreateSound( self.Owner, Sound( "weapons/gblaster2/reincarnation_holding.mp3" ) )
...
function SWEP:PrimaryAttack()
	...
	if self.Owner:KeyDown(IN_ATTACK) and self.CandoSpecial == true then
		...
		if self.Owner:IsPlayer() then
			if ( self.LoopSound ) then
				...
				self.LoopSound = CreateSound( self.Owner, Sound( "weapons/gblaster2/reincarnation_holding.mp3" ) )
	...
	if self.Owner:IsNPC() then
		...
		if ( self.LoopSound ) then
			...
			self.LoopSound = CreateSound( self.Owner, Sound( "weapons/gblaster2/reincarnation_firing.mp3" ) )
			if ( self.LoopSound ) then self.LoopSound:Play() end
		end
		if ( self.BeatSound ) then self.BeatSound:ChangeVolume( 0, 0.1 ) end
	end
	...
	local bullet = {} 
		...
		bullet.TracerName = "reincarnation_ray"
