...
SWEP.VElements = {
	["v_element"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "Base", rel = "", pos = Vector(-0.917, 18.593, 0.617), angle = Angle(-90, 90, 0), size = Vector(0.2, 0.2, 0.2), color = Color(255,199,0, 255, 255), surpresslightning = false, material = "models/shiney/purpleblood", skin = 0, bodygroup = {} },
	["v_element3"] = { type = "Model", model = "models/props_lab/console02c.mdl", bone = "Base", rel = "", pos = Vector(1.077, 2.611, -16.449), angle = Angle(0, 0, -90), size = Vector(0.2, 0.2, 0.2), color = Color(83,1,177, 255), surpresslightning = false, material = "models/shiney/purpleblood", skin = 0, bodygroup = {} },
	["v_element4"] = { type = "Model", model = "models/props_lab/labpar5.mdl", bone = "Base", rel = "", pos = Vector(-5.606, -5.584, -15.372), angle = Angle(0, 0, -90), size = Vector(0.6, 0.6, 0.6), color = Color(0,0,0, 255), surpresslightning = false, material = "models/shiney/purpleblood", skin = 0, bodygroup = {} },
	["v_element2"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "Base", rel = "", pos = Vector(0, 1, 10.357), angle = Angle(90, 0, -90), size = Vector(0.75, 0.75, 0.75), color = Color(0,0,0,255), surpresslightning = false, material = "models/shiney/purpleblood", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["w_element3"] = { type = "Model", model = "models/props_lab/console02c.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.872, -0.667, -7.375), angle = Angle(-161.691, 98.208, -4.663), size = Vector(0.119, 0.119, 0.119), color = Color(255,255,255, 255), surpresslightning = false, material = "models/shiney/purpleblood", skin = 0, bodygroup = {} },
	["w_element"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(15.817, -0.159, 0.344), angle = Angle(175.675, 11.01, -21.651), size = Vector(0.109, 0.109, 0.109), color = Color(255,199,0, 255), surpresslightning = false, material = "models/shiney/purpleblood", skin = 0, bodygroup = {} },
	["w_element2"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(23.502, -5.568, -10.129), angle = Angle(-30.803, 21.666, -157.198), size = Vector(0.5, 0.5, 0.5), color = Color(0,0,0, 255), surpresslightning = false, material = "models/shiney/purpleblood", skin = 0, bodygroup = {} },
	["w_element4"] = { type = "Model", model = "models/props_lab/labpar5.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.335, -5.299, -10.707), angle = Angle(0, 100.656, 5.102), size = Vector(0.5, 0.5, 0.5), color = Color(0,0,0, 255), surpresslightning = false, material = "models/shiney/purpleblood", skin = 0, bodygroup = {} }
}
...
function SWEP:Deploy()
	...
	self.BeatSound = CreateSound( self.Owner, Sound( "weapons/gblaster/bigshot_holding.mp3" ) )
	...
	if self.Owner:KeyDown(IN_ATTACK) and self.CandoSpecial == true then
		...
		if self.Owner:IsPlayer() then
			if ( self.LoopSound ) then
				...
				self.LoopSound = CreateSound( self.Owner, Sound( "weapons/gblaster/bigshot_firing.mp3" ) )
