...
SWEP.PrintName            = "Garry's Sherbert"
SWEP.Slot            = 3
SWEP.SlotPos            = 4
SWEP.DrawAmmo            = true
...
SWEP.VElements = {
	["v_element"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "Base", rel = "", pos = Vector(-0.917, 18.593, 0.617), angle = Angle(-90, 90, 0), size = Vector(0.2, 0.2, 0.2), color = Color(139, 128, 0, 255), surpresslightning = false, material = "models/shiney/sherbert3", skin = 0, bodygroup = {} },
	["v_element3"] = { type = "Model", model = "models/props_lab/console02c.mdl", bone = "Base", rel = "", pos = Vector(1.077, 2.611, -16.449), angle = Angle(0, 0, -90), size = Vector(0.2, 0.2, 0.2), color = Color(139, 128, 0, 255), surpresslightning = false, material = "models/shiney/sherbert3", skin = 0, bodygroup = {} },
	["v_element2"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "Base", rel = "", pos = Vector(0, -2.991, 10.357), angle = Angle(90, 0, -90), size = Vector(0.5, 0.5, 0.5), color = Color(139, 128, 0, 255), surpresslightning = false, material = "models/shiney/sherbert3", skin = 0, bodygroup = {} }
}
...
function SWEP:Deploy()
	...
	self.BeatSound = CreateSound( self.Owner, Sound( "weapons/gblaster/scary_garry_holding.wav" ) )
...
function SWEP:PrimaryAttack()
	...
	if ( self.Owner:IsNPC() ) then
		...
		if ( self.LoopSound ) then
			...
			self.LoopSound = CreateSound( self.Owner, Sound("weapons/gblaster/scary_garry_shooting.mp3") )
	...
	local bullet = {} 
		...
		bullet.TracerName = "scary_garry_ray"
...
function SWEP:DrawHUD()
    ...
    surface.SetDrawColor(Color(255,131,249))
    ...
    surface.SetDrawColor(255,131,249,255)
