...
if SERVER then
	...
	SWEP.VElements = {
		["Console"] = { type = "Model", model = "models/props_lab/console02c.mdl", bone = "Base", rel = "", pos = Vector(-2.921, 1.46, -16.449), angle = Angle(0, 0, -90), size = Vector(0.18, 0.18, 0.18), color = Color(255, 255, 255, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "models/fair/juju/kub/meat", skin = 0, bodygroup = {} },
		["Console+"] = { type = "Model", model = "models/props_lab/console02c.mdl", bone = "Base", rel = "", pos = Vector(-2.921, 1.46, -16.449), angle = Angle(0, 0, -90), size = Vector(0.18, 0.18, 0.18), color = Color(255, 255, 255, 44), surpresslightning = false, bonemerge = false, highrender = false, material = "models/fair/juju/kub/eye", skin = 0, bodygroup = {} },
		["Gaster"] = { type = "Model", model = "models/fair/prop/juju/prison_realm.mdl", bone = "Base", rel = "", pos = Vector(0, 8.793, 10.357), angle = Angle(90, 0, -90), size = Vector(2.932, 2.932, 2.932), color = Color(255, 255, 255, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "", skin = 1, bodygroup = {} },
		["Laser"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "Base", rel = "", pos = Vector(-0.917, 18.593, 0.616), angle = Angle(-90, 90, 0), size = Vector(0.2, 0.2, 0.2), color = Color(255, 255, 255, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "models/fair/juju/kub/meat", skin = 0, bodygroup = {} },
		["Laser+++++"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "Base", rel = "", pos = Vector(-0.917, 18.593, 0.616), angle = Angle(-90, 90, 0), size = Vector(0.2, 0.2, 0.2), color = Color(255, 255, 255, 44), surpresslightning = false, bonemerge = false, highrender = false, material = "models/fair/juju/kub/eye", skin = 0, bodygroup = {} }
	}
	
	SWEP.WElements = {
		["console"] = { type = "Model", model = "models/props_lab/console02c.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.872, -0.667, -7.375), angle = Angle(-158.491, 98.208, -4.664), size = Vector(0.123, 0.123, 0.123), color = Color(255, 255, 255, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "models/fair/juju/kub/meat", skin = 0, bodygroup = {} },
		["console+"] = { type = "Model", model = "models/props_lab/console02c.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.872, -0.667, -7.375), angle = Angle(-158.491, 98.208, -4.664), size = Vector(0.123, 0.123, 0.123), color = Color(255, 255, 255, 12), surpresslightning = false, bonemerge = false, highrender = false, material = "models/fair/juju/kub/eye", skin = 0, bodygroup = {} },
		["gaster"] = { type = "Model", model = "models/fair/prop/juju/prison_realm.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(36.46, -4.577, -1.17), angle = Angle(-12.957, 9.425, -160.866), size = Vector(2.679, 2.679, 2.679), color = Color(255, 255, 255, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "", skin = 0, bodygroup = {} },
		["laser"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(16.913, -0.159, 1.699), angle = Angle(175.675, 11.01, -21.651), size = Vector(0.116, 0.116, 0.116), color = Color(255, 255, 255, 255), surpresslightning = false, bonemerge = false, highrender = false, material = "models/fair/juju/kub/meat", skin = 0, bodygroup = {} },
		["laser++"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(16.913, -0.159, 1.699), angle = Angle(175.675, 11.01, -21.651), size = Vector(0.116, 0.116, 0.116), color = Color(255, 255, 255, 12), surpresslightning = false, bonemerge = false, highrender = false, material = "models/fair/juju/kub/eye", skin = 0, bodygroup = {} }
	}
	...
	hook.Add("EntityTakeDamage", "IncreaseDamageWhileHoldingWeapon", function(target, dmginfo)
		-- Check if the entity taking damage is a player
		if IsValid(target) and target:IsPlayer() then
			local weapon = target:GetActiveWeapon() -- Get the weapon the player is holding
	...
	function DrawSunbeamsOnWeaponHold(ply, weapon)
		if not IsValid(ply) or not IsValid(weapon) then return end
	
		if weapon:GetClass() == "weapon_prison_realm_gblaster" then -- Replace "weapon_example" with the class name of the weapon you want to trigger sunbeams
			local sunbeamData = {
				...
				EndSize = 0.6,
				Angle = 0,
				Texture = "sprites/physbeama",
				Color = Color(255, 255, 255, 255)
			}
			--util.DrawSunbeams(sunbeamData)
		end
	end
	
	hook.Add("Think", "CheckWeaponHold", function()
		for _, ply in ipairs(player.GetAll()) do
			if IsValid(ply) and ply:Alive() and IsValid(ply:GetActiveWeapon()) then
				DrawSunbeamsOnWeaponHold(ply, ply:GetActiveWeapon())
			end
		end
	end)
	...
	function SWEP:Deploy()
		...
		self.BeatSound = CreateSound( self.Owner, Sound( "weapons/gblaster/prisonrealm_holding.mp3" ) )
	...
	function SWEP:PrimaryAttack()
		...
		if ( self.Owner:IsNPC() ) then
			...
			if ( self.LoopSound ) then
				...
				self.LoopSound = CreateSound( self.Owner, Sound("weapons/gblaster/prisonrealm_firing.mp3") )
	...
	function SWEP:DrawHUD()
		...
		surface.SetDrawColor(Color(255,255,249))
