...
SWEP.PrintName            = "Fraudulence - Turning Point"
SWEP.Slot            = 3
SWEP.SlotPos            = 4
SWEP.DrawAmmo            = true
...
function SWEP:Deploy()
	...
	self.BeatSound = CreateSound( self.Owner, Sound( "weapons/gblaster/fraud3_holding.mp3" ) )
...
function SWEP:PrimaryAttack()
	...
	if ( self.Owner:IsNPC() ) then
		...
		if ( self.LoopSound ) then
			...
			self.LoopSound = CreateSound( self.Owner, Sound("weapons/gblaster/fraud3_firing.mp3") )
