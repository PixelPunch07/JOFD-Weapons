...
SWEP.Purpose			= "can i havz cheezburger plz"
...
SWEP.VElements = {
	["part"] = { type = "Model", model = "models/hunter/blocks/cube05x05x05.mdl", bone = "Base", rel = "", pos = Vector(0, -7.856, -11.525), angle = Angle(0, 0, 0), size = Vector(0.111, 0.111, 0.111), color = Color(192, 192, 192, 255), surpresslightning = false, material = "models/shiny", skin = 0, bodygroup = {} },
	["gaster"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "Base", rel = "", pos = Vector(0.455, -4.354, 24.118), angle = Angle(90, -90, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["laser"] = { type = "Model", model = "models/props_questionableethics/qe_primarylaser.mdl", bone = "Base", rel = "", pos = Vector(0.711, 13.442, -0.991), angle = Angle(-90, 90, 0), size = Vector(0.18, 0.18, 0.18), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["swor"] = { type = "Model", model = "models/robloxstuff/sword/sword.mdl", bone = "Base", rel = "", pos = Vector(0, -11.726, -11.742), angle = Angle(105.172, 0, 88.544), size = Vector(0.184, 0.184, 0.184), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["coil"] = { type = "Model", model = "models/weapons/scoil_arm.mdl", bone = "ValveBiped.Bip01_L_Forearm", rel = "", pos = Vector(-7.456, -6.228, 4.038), angle = Angle(0, 0, 0), size = Vector(0.889, 0.889, 0.889), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["firebrand+"] = { type = "Model", model = "models/robloxstuff/sword/swordbig.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "", pos = Vector(0, 2.585, -7.206), angle = Angle(0, 90, -43.106), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["firebrand"] = { type = "Model", model = "models/robloxstuff/sword/swordlarge.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "", pos = Vector(0, 2.006, 3.512), angle = Angle(0, 90, -128.254), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["gaster"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(40.241, -8.858, -14.315), angle = Angle(-16.157, 11.418, 180), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["part"] = { type = "Model", model = "models/hunter/blocks/cube05x05x05.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(8.109, -1.665, -15.235), angle = Angle(0, 12.001, 0), size = Vector(0.145, 0.145, 0.145), color = Color(192, 192, 192, 255), surpresslightning = false, material = "models/shiny", skin = 0, bodygroup = {} },
	["laser"] = { type = "Model", model = "models/props_questionableethics/qe_primarylaser.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(17.966, -3.868, 3.319), angle = Angle(180, 12.274, 0), size = Vector(0.156, 0.156, 0.156), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["swor"] = { type = "Model", model = "models/robloxstuff/sword/sword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(7.938, -1.482, -22.087), angle = Angle(0, 12.944, -2.52), size = Vector(0.421, 0.421, 0.421), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["coil"] = { type = "Model", model = "models/weapons/scoil_arm.mdl", bone = "ValveBiped.Bip01_L_Forearm", rel = "", pos = Vector(-5.952, -7.236, 4.499), angle = Angle(0, 0, 0), size = Vector(0.889, 0.889, 0.889), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
function SWEP:Deploy()
	...
	self.BeatSound = CreateSound( self.Owner, Sound( "weapons/gblaster/fjordwinds_hold.mp3" ) )
...
if self.mode == 3 and timer.TimeLeft( "coilheal"..self:EntIndex() ) == nil then

self.Owner:SetHealth(self.Owner:Health() +25) 
			timer.Create( "coilheal"..self:EntIndex(), 1, 1, function() end )	
end
...
function SWEP:PrimaryAttack()
	...
	if ( self.Owner:IsNPC() ) then
		...
		if ( self.LoopSound ) then
			...
			self.LoopSound = CreateSound( self.Owner, Sound( "weapons/gblaster/fjordwinds_fire.mp3" ) )
...
if self.mode == 1 then
self.mode = 2
self.VElements["coil"].color = Color(0,0,255,255)
elseif self.mode == 2 then
self.VElements["coil"].color = Color(0,255,0,255)
self.mode = 3
elseif self.mode == 3 then
self.VElements["coil"].color = Color(255,255,255,255)
self.mode = 1
