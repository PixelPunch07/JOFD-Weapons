...
function SWEP:Deploy()
	...
	self.BeatSound = CreateSound( self.Owner, Sound( "weapons/gblaster/heresy_holding.mp3" ) )
...
function SWEP:PrimaryAttack()
	...
	if ( self.Owner:IsNPC() ) then
		...
		if ( self.LoopSound ) then
			...
			self.LoopSound = CreateSound( self.Owner, Sound("weapons/gblaster/heresy_firing.mp3") )
